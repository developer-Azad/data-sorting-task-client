...
import Features from '../../../images/treatment.png';
...
const Feature = () => {
    return (
        <Box sx={{mt: 5}}>
            ...
            <Box sx={{mx: 5}}>
            <img style={{width: '70%'}} src={Features} alt="" />
            </Box>
            </Grid>
            <Grid item xs={12} md={7}>
                <Box sx={{textAlign: 'left', alignItems: 'center'}}>
                <p style={{margin: 0, fontSize: 30, fontWeight: 500}}>Exceptional Dental</p>
                <p style={{margin: 0, fontSize: 30, fontWeight: 500}}>Care, on Your Terms</p>
